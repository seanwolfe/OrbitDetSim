...
def main():
    ...
    # User parameters
    # =======================
    M = 3 # keep whatever you like here
    ...
    theta_s_list = np.array([np.deg2rad(25.0)] * M)
    ...
    # print(seed)
    seed = 1764367384
    # seed = 1764367384  # seed with M=2 where infeasible solution can be obtained due to slew limits
    # seed = 1764365898  # seed that shows how the mean may not always be optimal for M = 2
