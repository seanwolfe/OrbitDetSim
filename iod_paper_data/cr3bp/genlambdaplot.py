...
file_name = "bh_plus_range/CR3BP_Horizontal Lyapunov Orbits_GROUND_CONSTRAINED_BASIN_HOPPING_META_MASTER.csv"
...
pos_data = [data.loc[data['PHYSICS_WEIGHT'] == w, 'POS_RMSE'] * 1.5e8 for w in physics_weights]
