...
lambda_f_centers  = np.array([1e-4, 1e-3, 1e-2, 1e-1, 1e0, 1e1, 1e2, 1e3, 1e4])  # physics weight (x)
lambda_rho_centers = np.array([1e-4, 1e-3, 1e-2, 1e-1, 1e0, 1e1])            # range weight (y)
...
norm = mcolors.Normalize(vmax=0.005 * 149597871)
